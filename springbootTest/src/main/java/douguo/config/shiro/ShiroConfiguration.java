...
@Configuration public class ShiroConfiguration {
     ...
     */
    @Bean(name = "lifecycleBeanPostProcessor") public LifecycleBeanPostProcessor lifecycleBeanPostProcessor() {
     ...
     */
    @Bean(name = "shiroRealm") @DependsOn("lifecycleBeanPostProcessor") public ShiroRealm shiroRealm() {
     ...
     * //
     */
    @Bean(name = "securityManager") public DefaultWebSecurityManager securityManager() {
     ...
     */
    @Bean(name = "shiroFilter") public ShiroFilterFactoryBean shiroFilterFactoryBean() {
